...
let hero_img = document.querySelector("#hero .image img");
let story_img = document.querySelector("#story_img");
let contact_img = document.querySelector(".contact_img img");
window.addEventListener("scroll", () => {
    let scrollPos = window.scrollY;
    hero_img.style.transform = `translateY(${scrollPos * -0.3}px)`; // Adjust speed here
});
window.addEventListener("scroll", () => {
    let scrollPos = window.scrollY;
    story_img.style.transform = `translateY(${scrollPos * -0.1}px)`; // Adjust speed here
});
window.addEventListener("scroll", () => {
    let scrollPos = window.scrollY;
    contact_img.style.transform = `translateY(${scrollPos * -0.2}px)`; // Adjust speed here
});
